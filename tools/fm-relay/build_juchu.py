...
(function () {
  ...
  document.addEventListener('input', function (e) { var t = e.target; if (!t || !t.id) return; if (t.id === 'f-amt' || t.id === 'c-total' || t.id === 'f-price' || /^c-/.test(t.id)) { clearTimeout(金額タイマー); 金額タイマー = setTimeout(金額を出す, 300); } }, true);
